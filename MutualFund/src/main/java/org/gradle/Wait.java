...
final public class Wait {
	 ...
	 */
	public static WebDriverWait getWait(final WebDriver driver) {
	 ...
	 */
	public static WebDriverWait getWait(final WebDriver driver, final long timeOutInSeconds) {
	...
	public static ExpectedCondition<WebElement> isDisplayed(final WebElement webElement) {
		return new ExpectedCondition<WebElement>() {
			...
			public WebElement apply(final WebDriver arg0) {
	 ...
	 */
	public static void sleep(final int numNanoSeconds) {
		try {
	...
	private static String takeScreenshot(WebDriver driver) {
		...
		SimpleDateFormat currentDateFormatter = new SimpleDateFormat("yyyyMMdd", Locale.US);
		SimpleDateFormat currentTimeFormatter = new SimpleDateFormat("kkmmss", Locale.US);
